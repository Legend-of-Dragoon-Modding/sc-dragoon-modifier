...
-Hell Mode will turn on/off certain features every time a battle starts. Please note increasing your inventory is done through gameplay features now.
-Hell Mode bosses have "enrage" a mechanic that make them stronger the less HP they have.
-Hell Mode bosses have "shield" at certain thresholds they provide themselves a shield. 
-Hell Mode "powerful" items will change the elements of monsters on the field to that same element of the item.
-The special Faust through the DraMenu will grant Armor of Legend and Legend Casque after 40 battles or when someone in the party is level 60.
Details on how to active this are in the DraMenu section below.
...
All characters new special mechanics can be accessed using UP/DOWN to access the secondary battle menu during their turn to activate.
...
Lavitz/Albert has a special mechanic called Wind Mark and Wind Barrier.
Lavitz/Albert applies Wind Mark to enemies when using spells. When any party member attacks an enemy with Wind Mark they lose 30 Turn Points.
...
Enemies will gain the following Wind Marks when using the following spells.
    ...
    Gaspless              - 2
    Jade Dragon           - 3
Wind Barrier costs 10 MP per turn to use and whenver Lavitz/Albert are attacked the attacking monster will have 30 Turn Points removed.
...
Rose will provide additional healing to herself while using any attack in Dragoon form and others if using Astral Drain
    Astral Drain                - Heals an additional amount based on Rose's Max HP (Rose Max HP * Dragoon Level * 0.0425) to the whole party.
...
Rose's new mechanic is called Siphon Overflow and is based on Rose's Max HP upon entering battle. 
All attacks in Dragoon form count towards this number and Rose can gain up to 20% of her Max HP as Siphon per attack.
When full, the amount of Siphon is added to the base damage of the attack.
...
Kongol's mechanic is called Counter Stance. 
In this state Kongol's speed is set to 0 and whnever he is attacked he gains 218 turn points.
While in this state Kongol is considered to have Lesser Guard (20% damage reduction) and will heal 2% HP per turn.
 
===========================================================================================================================================================
DraMod Menu
===========================================================================================================================================================
Level Sync - Levels up players based on the character with the highest EXP in the Party (up to 80,000 EXP for Hard Mode and 160,000 EXP for Hell Mode).
Add Lavitz - Adds Lavitz whenever he is missing from the party.
Add Shana - Adds Shana whenever she is missing from the party.
Add Everyone - Adds everyone to the party.
Add Level 1 Party - Only available when you first gain control of Dart, adds everyone at level 1.
Dart Dragoon Swap - On the final map of the game swap between Divine and Red-Eye spirits.
Wingly Shop - While in the Forbidden Land access the Wingly item shop.
Next Ultimate Boss - While in the Forbidden Land after you the events in Flanvel Tower start the next Ultimate Boss you have not defeated. Details below.
Ultimate Boss - Refight an Ultimate Boss using the selector in the Main Menu->Gameplay->[DM] Ultimate Boss.
Rogue Shop - While in Aglis access the Rogue item shop.
Warp off Moon - In the first map of the Lunar Core (After Archangel) warp back to Ulara.
Warp to Moon - In Ulara, warp back to the Moon.
Start Faust - Fight a special boss in the map before the final Super Virage that grants Legend equips under certain conditions.
Hero Shop - After Hero Competition, open a similar shop so you don't have to spam tickets.
Elemental Bomb Shop - After Hero Competition, open a shop with Powerful Magic Items.
...
Ultimate Boss
After Flanvel Tower you can go back to The Forbidden Land to fight tougher versions of bosses. 
...
Each boss will reward one time rewards and will grant large amounts of gold the more bosses you defeat.
The expensive new equips can be found in the Black Castle by the Green and White Flame Reseachers.
You can exit the Black Castle using the New Serdio Party entrance.
...
Zone 3 - Level 50 - **NOT FINSHED FOR BETA
===========================================================================================================================================================
...
Zone 4 - Level 60 -  **NOT FINSHED FOR BETA
===========================================================================================================================================================
...
===========================================================================================================================================================
New Equips (Hard/Hell only)
===========================================================================================================================================================
Lava Blade         - Fire-based attack.
Stone Axe          - Earth-based attack.
Spectral Arrow     - Light-based attack.
Void Estoc         - Dark-based attack.
Hydro Hammer       - Water-based attack.
Attack Horn        - Raises physical & magical attack by 30.
Defense Horn       - Raises physical & magical defense by 30.
Spirit Eater       - Removes 20 SP per turn unless SP is full.
Giant Axe          - Will occasionally cast guard after physical dmg.
Dragon Beater      - Grants life and SP steal on physical attacks and provides additional siphon on all physical attacks.
Ouroboros          - Doubles Dragoon damage but costs 200 SP per turn and casts slow down on exit.
Elemental Arrow    - Provides unlimited arrows of each time of element for Shana.
Magic Hammer       - Transfers all physical power to magical damage but grants MP recovery even in Dragoon form and Max MP increase.
Overcharge Glove   - Thunder-based attack that deals more to thunder.
Crystal Armor      - Increases stats the more crystal equips are set.
Crystal Hat        - Increases stats the more crystal equips are set.
Crystal Boots      - Increases stats the more crystal equips are set.
Crystal Ring       - Increases stats the more crystal equips are set.
Ring of Reversal   - Reverse physical and magical defense.
Ring of Healing    - Heals 7% HP/MP and 7 SP per turn.
Ring of Power      - Raises physical attack by 60.
Ring of Magic      - Raises magical attack by 60.
Ring of Defense    - Raises physical defense by 60.
Ring of Block      - Raises magical defense by 60.
Ring of Shielding  - Chance to cast perfect shield before death.
Ring of Elements   - Extends dragoon space based on turns in special.
The One Ring       - Sets HP and Max HP to 1 and Avoid to 80%.
Lloyd's Boots      - Lloyd's favorite boots. Provides +10 of various stats. 
Divine DG Armor    - 20 SP and 10% MP on all hits.
Halo of Balance    - Raises maximum HP/MP by 30%.
Firebrand          - Fire and Divine based attack. Divine attacks deal more damage.
Super Spirit Ring  - Removes SP from additions. Gains 100 SP per turn.
Winged Shoes       - Raises evasion by 20%. Provides +5 of various stats.
Protection Shield  - Negates damage up to 50% Max HP per battle.
Spirit Bottle      - Recovers 80 SP on first turn of battle.
Speed Bottle       - Start battle with one extra turn on first turn once per battle.
Healing Bottle     - Recovers 70% HP when HP is critical once per battle.
Sun Bottle         - Recovers 20 MP when available once per battle.
Protection Shoes   - Negates damage up to 25% Max HP per battle.
Protection Helmet  - Negates damage up to 25% Max HP per battle.
Protection Armor   - Negates damage up to 50% Max HP per battle.
Fire Arrow         - Fire-based attack.
Water Arrow        - Water-based attack.
Wind Arrow         - Wind-based attack.
Earth Arrow        - Earth-based attack.
Dark Arrow         - Dark-based attack.
Light Arrow        - Light-based attack.
Thunder Arrow      - Thunder-based attack.
Fake Solitary Ring - Raises all stats when alone in battle.
Solitary Ring      - Raises all stats when alone in battle.
Fake Plague Boots  - Raises status chance by 20%.
Plague Boots       - Raises status chance by 40%.
Magicial Sollerets - Provides additonal defenses.
Magical Chausses   - Raises evasion by 15%.


===========================================================================================================================================================
New Items (Hard/Hell only)
===========================================================================================================================================================
Rock Fireflies     - Rarely found near Rock Fireflies. Glows faintly.
Perfect Shield     - Nullifies all attacks for 3 turns (repeat).
Weak Shield        - Creates a shield that absorbs damage based on 50% of the user's Max HP.
Shield Generator   - Creates a shield that absorbs damage based on 200% of the user's Max HP (repeat).
Super Spirit Pot   - Recovers 200 SP.
Superb Spirit Pot  - Recovers 700 SP.
Stellar Spirit Pot - Recovers 75 of SP(repeat).
